...
SoStonksは、以下のプラットフォームでご利用いただけるプロフェッショナル向けの戦略バックテストおよびテクニカル分析ツールです。
...
本ポリシーまたは本アプリ自体に関するご質問がございましたら、[support@sostonks.app](mailto:support@sostonks.app)までメールにてお問い合わせください。
