...
**SoStonks** — iOS, iPadOS, macOS, visionOS를 위한 전략 백테스트, 차트 분석 및 플레이백 시뮬레이션 앱 — 에 관한 법률 및 정책 문서입니다.
{: .lede}
...
SoStonks는 다음 플랫폼에서 이용 가능한 전문 전략 백테스트 및 기술적 분석 도구입니다.
...
자세한 내용은 [sostonks.app](https://sostonks.app)에서 확인하세요.

## 지원

본 정책 또는 앱 자체에 관한 문의 사항이 있으신가요? [support@sostonks.app](mailto:support@sostonks.app)으로 이메일을 보내주세요.
