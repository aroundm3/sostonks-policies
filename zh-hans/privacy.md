...
SoStonks（以下简称"**SoStonks**"或"**我们**"）是一款适用于 iOS 和 iPadOS 的策略回测、图表分析与回放模拟工具。本隐私政策说明本应用处理哪些信息、如何存储这些信息，以及您可行使的选择。
...
**电子邮件：** [gnoud17.thng@gmail.com](mailto:gnoud17.thng@gmail.com)
{: .contact-block}
