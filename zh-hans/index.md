...
SoStonks 的法律与政策文件——SoStonks 是一款适用于 iOS、iPadOS、macOS 和 visionOS 的策略回测、图表分析与回放模拟应用。
{: .lede}
...
SoStonks 是一款专业的策略回测与技术分析工具，适用于以下平台：
...
访问 [sostonks.app](https://sostonks.app) 了解更多信息。

## 支持

对这些政策或本应用本身有任何疑问？请发送电子邮件至 [support@sostonks.app](mailto:support@sostonks.app)。
